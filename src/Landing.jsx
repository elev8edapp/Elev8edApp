    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
        <div className="absolute inset-0 opacity-50">
          <div className="absolute top-20 left-10 w-72 h-72 bg-[var(--brand-green-glow)] rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-gray-800/20 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button
                size="lg"
                className="bg-[var(--brand-green)] hover:bg-[var(--brand-green-dark)] text-black border-none rounded-full px-12 py-4 text-lg font-medium transition-all duration-300 transform hover:scale-105 w-full sm:w-auto"
              >
                <Apple className="w-6 h-6 mr-3" />
                Download for iOS
